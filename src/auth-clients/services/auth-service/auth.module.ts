...
import { AuthController } from './localAuth/auth.controller';
...
import { AuthLocalService } from './localAuth/auth.service';
import { GithubAutlConfig } from 'src/config/githubAuth.config';
import { GithubController } from './githubAuth/github.controller';
import { GithubService } from './githubAuth/github.service';
